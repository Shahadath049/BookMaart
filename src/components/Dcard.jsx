...
import styles from "./Dcard.module.css"; // Import the CSS module
import { setStoredBookId } from "@/utilities/addToDb";
...
const Dcard = ({ bookId , selectedBook }) => {
    // console.log(selectedBook);
    const { publisher, totalPages, author, image, bookName } = selectedBook;
  return (
    <div className={styles.parent}>
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          <span className={styles.title}>{bookName}</span>
          ...
          <span className={styles.text}>{totalPages}  pages</span>
        ...
        <div className={styles.bottom}>
          ...
          <button onClick={() => handleReadMore(bookId)} className="relative group border-none bg-transparent p-0 outline-none cursor-pointer font-mono font-light uppercase text-base">
      ...
      <div className="relative flex items-center justify-between py-2 px-2 text-xs text-green rounded-lg transform -translate-y-1 bg-gradient-to-r from-[#21f2b3] via-[#40e9db] to-[#238a79]  transition duration-[600ms] ease-[cubic-bezier(0.3,0.7,0.4,1)] group-hover:-translate-y-1.5 group-hover:duration-[250ms] group-active:-translate-y-0.5 brightness-100 group-hover:brightness-110">
